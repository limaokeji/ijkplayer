...
void MP4File::Read(char * fileName, FILE * pFILE)
{
...
void MP4File::GenerateTracks()
{
	...
	while (true) {
		...
		pTrakAtom->FindProperty("trak.tkhd.trackId",(MP4Property**)&pTrackIdProperty);

		// find track type property
		MP4StringProperty* pTypeProperty = NULL;
		pTrakAtom->FindProperty("trak.mdia.hdlr.handlerType",(MP4Property**)&pTypeProperty);
...
MP4SampleId MP4File::MP4GetNextSyncSampleId(
	MP4TrackId trackId,
	MP4SampleId curSampleId)
{
	return m_pTracks[FindTrackIndex(trackId)]->GetNextSyncSample(curSampleId);
}

u_int64_t MP4File::MP4GetSampleFileOffset(
	MP4TrackId trackId,
...
u_int32_t MP4File::MP4GetSyncSampleCount(
	MP4TrackId trackId)
{
	return m_pTracks[FindTrackIndex(trackId)]->GetSyncSampleCount();
}
