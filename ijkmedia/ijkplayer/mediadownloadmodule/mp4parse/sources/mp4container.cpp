...
bool MP4Container::FindProperty(const char *name,MP4Property** ppProperty, u_int32_t* pIndex)
{
	if (pIndex) 
	{
...
void MP4Container::FindIntegerProperty(const char* name, MP4Property** ppProperty, u_int32_t* pIndex)
{
	if (!FindProperty(name, ppProperty, pIndex))
	{
		throw new MP4Error("no such property","MP4Container::FindIntegerProperty");
	}
	...
	case Integer64Property:
		break;
	default:
		throw new MP4Error("type mismatch", "MP4Container::FindIntegerProperty");
	}
}
	...
	MP4Property** ppProperty, u_int32_t* pIndex)
{
	if (!FindProperty(name, ppProperty, pIndex))
	{
		throw new MP4Error("no such property","MP4Container::FindFloatProperty");
	}
	if ((*ppProperty)->GetType() != Float32Property) 
	{
		throw new MP4Error("type mismatch",	"MP4Container::FindFloatProperty");
	}
}
...
void MP4Container::GetBytesProperty(const char* name,u_int8_t** ppValue, u_int32_t* pValueSize)
{
	MP4Property* pProperty;
	u_int32_t index;
...
void MP4Container::SetBytesProperty(const char* name, const u_int8_t* pValue, u_int32_t valueSize)
{
	MP4Property* pProperty;
	u_int32_t index;
