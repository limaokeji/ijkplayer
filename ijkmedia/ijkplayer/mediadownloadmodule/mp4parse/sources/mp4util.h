...
inline MP4Timestamp MP4GetAbsTimestamp() 
{
	...
	struct timeval tv;
//============begin modify by penghs 2008-8-20 16:13:05=============
//	gettimeofday(&tv, NULL);
//============end   modify by penghs 2008-8-20 16:13:05=============
	MP4Timestamp ret;
	ret = tv.tv_sec;
	ret += 2082844800;
//	ret = ::GetTickCount();
...
u_int64_t MP4ConvertTime(u_int64_t t, u_int32_t oldTimeScale, u_int32_t newTimeScale);
...
const char* MP4NormalizeTrackType(const char* type,uint32_t verbosity);
