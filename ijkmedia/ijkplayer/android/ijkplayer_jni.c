...
static void IjkMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this, jlong playRequestTime, jint isLimaoPlayMode);
...
IjkMediaPlayer_reset(JNIEnv *env, jobject thiz)
{
    ...
    IjkMediaPlayer_native_setup(env, thiz, weak_thiz, 0, 0);
...
static void
IjkMediaPlayer_native_setup(JNIEnv *env, jobject thiz, jobject weak_this, jlong playRequestTime, jint isLimaoPlayMode)
{
    MPTRACE("%s\n", __func__);
    IjkMediaPlayer *mp = ijkmp_android_create(message_loop);
    JNI_CHECK_GOTO(mp, env, "java/lang/OutOfMemoryError", "mpjni: native_setup: ijkmp_create() failed", LABEL_RETURN);

    mp->ffplayer->isLimaoPlayMode = isLimaoPlayMode; // add by tiangui @ 20151109
...
static JNINativeMethod g_methods[] = {
    ...
    { "native_setup",           "(Ljava/lang/Object;JI)V", (void *) IjkMediaPlayer_native_setup },
